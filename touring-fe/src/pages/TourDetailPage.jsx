        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-gray-500">({tour.reviews?.toLocaleString()} Đánh giá)</span>
                </div>
            ...
            <button
              ...
              className={`p-2 rounded-full border ${isFav ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'} hover:shadow-sm transition-all`}
            >
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2 text-sm">
                <p>• Dịch vụ đón/tiễn ưu tiên tại sân bay (fast track) sẽ giúp quý khách tiết kiệm thời gian, đặc biệt vào các khung giờ cao điểm, trong quá trình chờ đợi làm thủ tục tại sân bay.</p>
                <p>• Tại sân bay, đại diện của chúng tôi sẽ chào đón quý khách và hỗ trợ quý khách trong mọi thủ tục giấy tờ tại sân bay một cách nhanh chóng và thuận tiện nhất</p>
                {!showMoreService && (
                <button
                ...
                {showMoreService && (
                <p className="text-sm text-gray-600 mt-2">{tour.moreServiceInfo}</p>
                )}
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 space-y-1">
                    ...
                    <p>• Trẻ em dưới 2 tuổi được miễn phí nhưng phải đi cùng ít nhất một người lớn. Nếu bạn có trẻ em dưới 2 tuổi đi kèm, vui lòng cung cấp họ tên đầy đủ, quốc tịch và năm sinh tại trang thanh toán</p>
                  </div>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Thông tin thêm</h3>
                  <div className="text-sm text-gray-600 space-y-1">
                    <p>• <strong>Chú ý:</strong> Travyy và nhà cung cấp dịch vụ sẽ không chịu trách nhiệm cho những vấn đề liên quan đến VISA của quý khách. Dịch vụ đón tiễn ưu tiên không bao gồm dịch vụ VISA</p>
              ...
              <div className="border-t pt-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm">
                      Một giá đình cả hài bé mới biết đi và một em bé đây là một lần đi KHÔNG CẦN PHẢI SUY NGHĨ. Sân bay TSN không có hàng ưu tiên, vì vậy dịch vụ này rất cần thiết, đặc biệt đối với những người phải bắt chuyến bay khác, như chúng tôi. Rất đáng giá.
                    </p>
